...
- Licensing: `HOLD`
- Review: two-pass same evaluator; not independent human appraisal
...
- Native Google Sheet v0.3: https://docs.google.com/spreadsheets/d/1cJT8ViUgt8e8C02TksLNtUi7Gcp9QiFXjHHRX3EMV8Q
...
- REC 6.19 evidence map: https://docs.google.com/document/d/1ZHZpbCJwRQNjBmkEIT7z_hnGP2C5NMBcoXGzGH0aZ1k
- AGREE II appraisal: https://docs.google.com/document/d/16SIGWTrakBUgCwnFmGF-GH2eSz1p_V3na9jtvtwl-mA

## Repository

- Repository: `Emad211/clinic_managment`
- Branch: `research/ada-2026-evidence-v0.2`
- Protected publisher PDFs and the binary workbook are not committed.
