...
> برگرفته از مشورتِ تیم (`clinical-product-advisor` + `frontend-dev-advisor` + `backend-dev-advisor`، ۱۴۰۵/۰۳/۳۱). هم‌خانواده: [ADR-0002](adr/0002-context-boundaries.md) · [ADR-0003](adr/0003-integration-seam-outbox.md) · [`record_redesign_plan.md`](record_redesign_plan.md).
