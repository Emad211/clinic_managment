...
| [`ACCOUNTING.md`](ACCOUNTING.md) | پورتِ حسابداریِ لگاسی به پلتفرم + عمومی‌سازی (نوعِ کلینیک، بیمهٔ پر-کلینیک، کاتالوگِ قابلِ‌ویرایش، ترتیبِ ساخت) | زنده v0.1 |
