...
> آخرین به‌روزرسانی: حلقهٔ چهارم — ۴۰ قدم (۲۱–۶۰) قفل؛ **۲۱–۳۷ ✅** (۱۷ قدم؛ 🏁 خوشه‌های G و H کامل؛ خوشهٔ I در حالِ پیشروی). تست: بک‌اند **۴۳۱**، وب **۳۶۳**، نگهبان ۱۰۵. ریسک‌های #۷/#۱۰/#۱۱ بسته. بعدی: قدم ۳۸ (خوشهٔ I بالینی: ردیابیِ اثرِ دارو — `GET .../medications/{id}/effect` دلتای پیش/پسِ ۹۰روزه، `data_insufficient` به‌جای عددِ ساختگی؛ clinical-research-advisor). وضعیتِ هر قدم با ✅ علامت می‌خورد.
