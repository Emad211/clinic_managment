...
> آخرین به‌روزرسانی: حلقهٔ چهارم — ۴۰ قدم (۲۱–۶۰) قفل؛ **۲۱–۲۸ ✅** (۸ قدم). ⚠️ **`halqe/web/` بیش از فرضِ ROADMAP** — فرمِ ثبتِ ویزیت (قدم ۳۰) در `/patients/[uuid]` هست؛ قدم‌های H را اول گراندینگ کن. بعدی: قدم ۲۹ (`/queue` صفِ پزشک — احتمالاً صفحه‌اش نیست، to-build؛ frontend). وضعیتِ هر قدم با ✅ علامت می‌خورد.
