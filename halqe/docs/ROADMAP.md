...
> آخرین به‌روزرسانی: حلقهٔ چهارم — ۴۰ قدم (۲۱–۶۰) قفل؛ **قدم ۲۱ (CI) ✅** (آرتیفکت + لوکال validate؛ گِیتِ Actions با مالک). بعدی: قدم ۲۲ (سخت‌سازیِ بوتِ production). وضعیتِ هر قدم با ✅ علامت می‌خورد.
