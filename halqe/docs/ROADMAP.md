...
> آخرین به‌روزرسانی: حلقهٔ چهارم — ۴۰ قدم (۲۱–۶۰) قفل؛ **۲۱–۳۹ ✅** (۱۹ قدم؛ 🏁 خوشه‌های G و H کامل؛ خوشهٔ I در حالِ پیشروی؛ قدم ۳۹ مکانیزم ساخته شد ولی ⛔ گِیتِ تأییدِ پزشک معلق — هیچ آستانهٔ per-population زنده نیست). تست: بک‌اند **۴۸۰**، وب ۳۶۳، نگهبان ۱۰۵. ریسک‌های #۷/#۱۰/#۱۱ بسته. بعدی: قدم ۴۰ (خوشهٔ I بالینی، **owner-gated**: پاسِ روزآمدیِ آستانه‌ها — `clinical_indicators` در برابر ADA/KDIGO/ESC + هم‌گامیِ fallbackها/docs؛ clinical-research + متخصص‌ها). وضعیتِ هر قدم با ✅ علامت می‌خورد.
