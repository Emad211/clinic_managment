...
> آخرین به‌روزرسانی: حلقهٔ چهارم — ۴۰ قدم (۲۱–۶۰) قفل؛ **۲۱–۳۸ ✅** (۱۸ قدم؛ 🏁 خوشه‌های G و H کامل؛ خوشهٔ I در حالِ پیشروی). تست: بک‌اند **۴۴۳**، وب ۳۶۳، نگهبان ۱۰۵. ریسک‌های #۷/#۱۰/#۱۱ بسته. بعدی: قدم ۳۹ (خوشهٔ I بالینی، **owner-gated**: گریدِ red-flag per-population — سالمندِ frail vs جوان، آستانه با تأییدِ هیئت/پزشک؛ endocrinology+cardiology). وضعیتِ هر قدم با ✅ علامت می‌خورد.
