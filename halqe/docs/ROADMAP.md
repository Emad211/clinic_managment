...
> آخرین به‌روزرسانی: حلقهٔ چهارم — ۴۰ قدم (۲۱–۶۰) قفل؛ **۲۱–۳۵ ✅** (۱۵ قدم؛ 🏁 خوشه‌های G و H کامل؛ خوشهٔ I آغاز شد). تست: بک‌اند **۳۹۹**، وب **۳۱۹**، نگهبان ۹۰. ریسک‌های #۷/#۱۰/#۱۱ بسته. بعدی: قدم ۳۶ (خوشهٔ I بالینی: لایهٔ دادهٔ تداخلِ دارویی DDI — `ddi_pairs` + سرفیسِ suggestion-only، ≤۱۵ جفتِ high-certainty؛ clinical-pharmacist-advisor). وضعیتِ هر قدم با ✅ علامت می‌خورد.
