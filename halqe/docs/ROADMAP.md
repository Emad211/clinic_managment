...
> آخرین به‌روزرسانی: حلقهٔ چهارم — ۴۰ قدم (۲۱–۶۰) قفل؛ **۲۱–۳۶ ✅** (۱۶ قدم؛ 🏁 خوشه‌های G و H کامل؛ خوشهٔ I در حالِ پیشروی). تست: بک‌اند **۴۱۲**، وب **۳۴۱**، نگهبان **۱۰۵**. ریسک‌های #۷/#۱۰/#۱۱ بسته. بعدی: قدم ۳۷ (خوشهٔ I بالینی: تقویمِ غربالگری — `GET /patients/{uuid}/screening-timeline` از `due_clinical_events`؛ gp-family-medicine-advisor). وضعیتِ هر قدم با ✅ علامت می‌خورد.
