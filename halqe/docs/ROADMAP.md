...
> آخرین به‌روزرسانی: حلقهٔ چهارم — ۴۰ قدم (۲۱–۶۰) قفل؛ **۲۱–۳۳ ✅** (۱۳ قدم؛ 🏁 خوشهٔ H کامل). تست: بک‌اند ۳۸۰، وب ۳۰۶، نگهبان ۷۹. بعدی: قدم ۳۴ (خوشهٔ G: authِ `SECURITY DEFINER` `auth_lookup_user` — رفعِ ریسک #۱۰ `platform.users` cross-read؛ api-platform-engineer). وضعیتِ هر قدم با ✅ علامت می‌خورد.
