...
> آخرین به‌روزرسانی: حلقهٔ چهارم — ۴۰ قدم (۲۱–۶۰) قفل؛ **۲۱–۳۴ ✅** (۱۴ قدم؛ 🏁 **خوشه‌های G و H کامل**). تست: بک‌اند **۳۸۰**، وب ۳۰۶، نگهبان **۹۰**. ریسک‌های #۷/#۱۰/#۱۱ بسته. بعدی: قدم ۳۵ (خوشهٔ I بالینی: شفافیتِ «قاعدهٔ خاموش» + تمیزکردنِ کامنتِ کهنهٔ `rule_engine.py`؛ هیئتِ بالینی). وضعیتِ هر قدم با ✅ علامت می‌خورد.
