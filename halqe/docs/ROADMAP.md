...
> آخرین به‌روزرسانی: حلقهٔ چهارم — ۴۰ قدم (۲۱–۶۰) قفل؛ **۲۱–۴۰ ✅** (۲۰ قدم؛ نیمهٔ راه؛ 🏁 خوشه‌های G، H، I کامل). تست: بک‌اند **۴۸۲**، وب ۳۶۳، نگهبان ۱۰۵. ریسک‌های #۷/#۱۰/#۱۱ بسته؛ گِیت‌های معلق: approveِ آستانهٔ per-population (۳۹) + پیشنهادهای currency (۴۰). بعدی: قدم ۴۱ (**خوشهٔ K — سنجشِ پیامد**: آمارِ پیشنهاد + لاگِ رویدادمحورِ append برای `suggestion_log`؛ clinical-data-scientist). وضعیتِ هر قدم با ✅ علامت می‌خورد.
