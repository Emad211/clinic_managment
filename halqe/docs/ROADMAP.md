...
> آخرین به‌روزرسانی: حلقهٔ چهارم — ۴۰ قدم (۲۱–۶۰) قفل؛ **۲۱–۴۸ ✅** (۲۸ قدم؛ 🏁 خوشه‌های G، H، I کامل؛ J در حالِ پیشروی — ۴۴/۴۵/۴۶/۴۷/۴۸ ✅). تست: بک‌اند **۶۰۷**، وب **۴۶۱**، نگهبان ۱۱۱. ریسک‌های #۷/#۱۰/#۱۱ بسته؛ گِیت‌های معلق: approveِ per-population (۳۹)، currency (۴۰)، consentِ holdout (۴۳)، LAN-vs-internetِ کارت + لینکِ SMS (۴۴/۴۸، پشتِ KYC + internet-exposure). زیرساخت: ترتیبِ numeric + VIEWها re-apply-safe. **گیتِ ایمنیِ خوداظهار کامل (۴۵/۴۷)؛ کارتِ بیمار + یادآورِ leak-proof (۴۴/۴۸).** بعدی: قدم ۴۹ (خوشهٔ K/آنالیتیکس: جدولِ outcomeِ کوهورت — **گِیتِ داده: نیازمندِ ماه‌ها دادهٔ واقعی**) یا اگر ۴۹ گِیت‌شده بماند، قدمِ بعدیِ بازِ ساختنی. وضعیتِ هر قدم با ✅ علامت می‌خورد.
