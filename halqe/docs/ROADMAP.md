...
> آخرین به‌روزرسانی: حلقهٔ چهارم — ۴۰ قدم (۲۱–۶۰) قفل؛ **۲۱–۳۲ ✅** (۱۲ قدم؛ 🏁 **خوشهٔ H کامل**). تست: بک‌اند ۳۸۰، وب ۳۰۶، نگهبان ۷۹. بعدی: قدم ۳۳ (خوشهٔ G: Dockerfile + gunicorn + compose + entrypoint؛ devops-engineer؛ net-new). وضعیتِ هر قدم با ✅ علامت می‌خورد.
