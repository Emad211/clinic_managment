...
> آخرین به‌روزرسانی: حلقهٔ چهارم — ۴۰ قدم (۲۱–۶۰) قفل؛ **۲۱–۴۲ ✅** (۲۲ قدم؛ 🏁 خوشه‌های G، H، I کامل؛ خوشهٔ K در حالِ پیشروی). تست: بک‌اند **۵۰۴**، وب ۳۶۳، نگهبان ۱۰۶. ریسک‌های #۷/#۱۰/#۱۱ بسته؛ گِیت‌های معلق: approveِ آستانهٔ per-population (۳۹) + پیشنهادهای currency (۴۰). زیرساخت: ترتیبِ برش‌ها numeric (slice11+ امن). بعدی: قدم ۴۳ (خوشهٔ K: فلگِ holdoutِ تعامل — `engagement_holdout` + skip در dispatcher + تخصیصِ تصادفی؛ stepped-wedge اخلاقی؛ clinical-data-scientist). وضعیتِ هر قدم با ✅ علامت می‌خورد.
