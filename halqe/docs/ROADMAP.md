...
> آخرین به‌روزرسانی: حلقهٔ چهارم — ۴۰ قدم (۲۱–۶۰) قفل؛ **۲۱–۲۷ ✅**. ⚠️ **`halqe/web/` بیش از فرضِ ROADMAP** — فرمِ ثبتِ ویزیت (قدم ۳۰) هم در `/patients/[uuid]` هست؛ قدم‌های H را اول گراندینگ کن. بعدی: قدم ۲۸ (G: `/healthz`+`/readyz` + لاگِ ساخت‌یافته + request-id؛ backend-engineer). وضعیتِ هر قدم با ✅ علامت می‌خورد.
